...
namespace Koturn.VRChat.Log
{
    ...
    public class VRCExLogWatcher(int watchCycle) : VRCLogWatcher(watchCycle), IVRCExLogEvent
    {
            ...
            : VRCCoreExLogParser(filePath)
        {
            ...
            {
                _logWatcher.BulletTimeAgentSaved?.Invoke(_logWatcher, new SaveEventArgs(FileName, LogUntil, saveText));
            }
            ...
            {
                _logWatcher.IdleCubeSaved?.Invoke(_logWatcher, new SaveEventArgs(FileName, LogUntil, saveText));
            }
            ...
            {
                _logWatcher.IdleDefenseSaved?.Invoke(_logWatcher, new SaveEventArgs(FileName, LogUntil, saveText));
            }
            ...
            {
                _logWatcher.IdleHomeSaved?.Invoke(_logWatcher, new SaveEventArgs(FileName, LogUntil, saveText));
            }
            ...
            {
                _logWatcher.MagicalCursedLandSaved?.Invoke(_logWatcher, new SaveEventArgs(FileName, LogUntil, saveText));
            }
            ...
            {
                _logWatcher.RhapsodySaved?.Invoke(_logWatcher, new SaveEventArgs(FileName, LogUntil, saveText));
            }
            ...
            {
                _logWatcher.TerrorsOfNowhereSaved?.Invoke(_logWatcher, new SaveEventArgs(FileName, LogUntil, saveText));
            }
            ...
            {
                _logWatcher.TonKillerTargetChanged?.Invoke(_logWatcher, new TonKillerNameEventArgs(FileName, LogUntil, terrorName));
            }
            ...
            {
                _logWatcher.TonPlayerDead?.Invoke(_logWatcher, new TonPlayerDeadEventArgs(FileName, LogUntil, playerName, message));
            }
            ...
            {
                _logWatcher.TonPlayerDamaged?.Invoke(_logWatcher, new TonPlayerDamagedEventArgs(FileName, LogUntil, damage));
            }
            ...
            {
                _logWatcher.TonKillerStunned?.Invoke(_logWatcher, new TonKillerNameEventArgs(FileName, LogUntil, terrorName));
            }
            ...
            {
                _logWatcher.TonKillerEnraged?.Invoke(_logWatcher, new TonKillerEnragedEventArgs(FileName, LogUntil, terrorName, enrageLevel));
            }
            ...
            {
                _logWatcher.TonKillerSet?.Invoke(_logWatcher, new TonKillerSetEventArgs(FileName, LogUntil, terrorIndex1, terrorIndex2, terrorIndex3, roundName));
            }
            ...
            {
                _logWatcher.TonKillerUnlocked?.Invoke(_logWatcher, new TonKillerUnlockedEventArgs(FileName, LogUntil, indexType, terrorIndex));
            }
            ...
            {
                _logWatcher.TonEquipped?.Invoke(_logWatcher, new TonEquipEventArgs(FileName, LogUntil, itemIndex, lastItemIndex));
            }
            ...
            {
                _logWatcher.TonRoundStarted?.Invoke(_logWatcher, new TonRoundStartedEventArgs(FileName, LogUntil, placeName, placeIndex, roundName));
            }
            ...
            {
                _logWatcher.TonRoundFinished?.Invoke(_logWatcher, new TonRoundFinishedEventArgs(FileName, LogUntil, result));
            }
        }
    }
}

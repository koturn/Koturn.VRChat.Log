...
namespace Koturn.VRChat.Log.Events
{
    ...
    public class UserLeaveEventArgs(string? logFileName, DateTime logAt, string userName, string? userId, DateTime stayFrom, DateTime? stayUntil, InstanceInfo instanceInfo)
        : UserJoinEventArgs(logFileName, logAt, userName, userId, stayFrom, instanceInfo)
    {
        /// <summary>
